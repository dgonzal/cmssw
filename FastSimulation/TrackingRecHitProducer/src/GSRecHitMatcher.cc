...
//   }
  ...
  if(det.subdetId() > 2) {
    ...
    SiTrackerGSRecHit2D *adjustedStereoRH = new SiTrackerGSRecHit2D(LocalPoint(stereoRH->localPosition().x(),0,0),
								    ...
								    *stereoRH->det(),
								    stereoRH->Id(),
								    stereoRH->simtrackId1(),
								    stereoRH->simtrackId2(),
								    stereoRH->eeId(),
								    stereoRH->simMultX(),
								    stereoRH->simMultY()
								    );
					            ...
					            LocalVector& ldir) const
{
  ...
  SiTrackerGSRecHit2D *otherRH = new SiTrackerGSRecHit2D(LocalPoint(-10000,-10000,-10000), LocalError(0,0,0),*otherDet, 0,0,0,0,0,0);
